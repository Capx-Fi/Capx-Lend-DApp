...
import { Tabs, Button, Radio, Input, Select, Slider, Tooltip, Checkbox } from "antd";
							...
							<TabPane tab='Borrow' key='1'>
								...
								<Row>
									<Col className="mb-4">
										...
										<Slider tooltipVisible label={null} className="slider-capx" step={null} marks={marks} defaultValue={10} />
									</Col>
								</Row>
								<Row>
									<Col className="mb-4">
